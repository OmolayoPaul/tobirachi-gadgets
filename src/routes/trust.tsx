    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="prose prose-invert mt-8 max-w-none space-y-8 text-sm text-muted-foreground">
        ...
        <section>
          ...
          <p>Report a security concern to Tobi Ajuyah on WhatsApp at <a href="https://wa.me/2349093929840" className="text-primary underline">+234 909 392 9840</a> or by email at <a href="mailto:tobirachigadgets@gmail.com" className="text-primary underline">tobirachigadgets@gmail.com</a>.</p>
        </section>
      </div>
    </div>
  );
